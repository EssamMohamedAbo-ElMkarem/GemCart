class Admin::OrdersController < AdminController
  ...
  def index
    ...
    @fulfilled_orders = Order.where(fulfilled: false).order(created_at: :asc)
    @not_fulfilled_orders = Order.where(fulfilled: true).order(created_at: :asc)
  end
  ...
  private
    ...
    def admin_order_params
      params.require(:order).permit(:customre_email, :fulfilled, :total, :address)
    end
end
